...
exports.default = [{
    ...
    program: {
        ...
        assurance: "<li>Gratuité de tous les soins</li><li>Supprimer les franchises</li>",
        desert: "<li>Développer les maisons de santé</li><li>Introduire des mesures contraignantes d'installation en cas d'échec des politiques incitatives</li>",
        santePublic: "<li>Renforcer la prévention contre les pratiques addictives et l'éducation à la santé</li><li>Ouvrir un débat sur la légalisation du cannabis</li>"
    }
}, {
    lastName: "Asselineau",
    firstName: "François",
    ...
    program: {
        ...
        assurance: "<li>Assurer une prise en charge de la maladie à 100 % par la Sécurité sociale</li><li>Arrêter les déremboursements de médicaments</li><li>Améliorer le remboursement des soins oculaires et dentaires</li><li>Suspendre les autorisations de commercialisation pour les centaines de médicaments inefficaces ou dangereux (après une étude indépendante)</li>",
        desert: "<li>Adapter le numerus clausus aux besoins de la France</li><li>Revoir les capacités de formation en fonction des besoins</li>",
        santePublic: "<li>Obliger les laboratoires à fournir la forme trivalent du vaccin DTP</li><li>Lancer une grande politique publique de médecines douces et alternatives pour rendre la médecine moins dépendante des labos</li><li>Accompagner, former et soutenir financièrement les aidants</li>"
    }
}, {
    lastName: "Cheminade",
    firstName: "Jacques",
    ...
    program: {
        ...
        assurance: "<li>Créer une Sécurité sociale intégrale incluant la couverture complémentaire</li><li>Rembourser à 100 % les soins dentaires, d'optique et auditifs</li><li>Supprimer le ticket modérateur</li><li>Supprimer le forfait de 18 euros sur les actes médicaux lourds</li><li>Prélever 5 euros aux patients en cas de rendez-vous non honoré</li><li>Stopper les AMM des fausses nouveautés visant à contourner les génériques</li><li>Contrôler plus sévèrement les prix des molécules innovantes</li><li>Exiger l'indépendance absolue des experts pour la mise sur le marché de nouveaux médicaments</li><li>Réduire les dépenses de somnifères, anxiolytiques et thymorégulateurs</li>",
        desert: "<li>Encourager la télémédecine</li><li>Augmenter le numerus clausus pour former jusqu'à 10 000 médecins par an</li><li>Mettre à contribution les services médicaux de l'armée</li><li>Réorganiser les maisons de santé</li>",
        santePublic: "<li>Donner la priorité à la prévention</li>"
    }
}, {
    ...
    program: {
        ...
        assurance: "<li>Fixer une progression de l'ONDAM à environ 2,5 %</li><li>Rembourser à chaque Français de plus de 40 ans un bilan de santé régulier</li><li>Améliorer le remboursement des soins dentaires de base (100 % pour les prothèses dentaires)</li><li>Rembourser à 100 % une paire de lunettes tous les 4 ans sur un panel de montures et de verres négociés</li><li>Rembourser le montant d'une prothèse auditive tous les 5 ans</li><li>Élargir les conditions d'accès à la CMU pour les plus de 65 ans</li><li>Diminuer les dépenses de fonctionnement des agences via des fusions</li><li>Supprimer l'AME et la remplacer par une aide exceptionnelle pour les urgences et les maladies contagieuses</li><li>Réunir les États généraux de la santé pour construire un régime de Sécurité sociale unique</li><li>Assurer plus de transparence sur la constitution du prix des médicaments</li><li>Dérembourser les médicaments dont le bénéfice est douteux ou inexistant</li>",
        desert: "Aucune proposition connue à ce jour",
        santePublic: "<li>Mettre en place un modèle de santé préventif (médecine prédictive) en s'appuyant sur les nouvelles technologies</li><li>Dispenser des cours de santé au collège</li><li>Sensibiliser aux méfaits de la malbouffe notamment auprès des populations les plus vulnérables</li><li>Lancer des campagnes de prévention (obésité, médicamentation, tabac, alcool...)</li><li>Réglementer davantage l'implantation des antennes relais (téléphonie mobile)</li><li>Donner la liberté de choix vaccinnale entre DT-Polio et l'hexavalent, relancer la production du DT-Polio</li><li>Doubler le nombre d'unités de soins palliatifs dans les EHPAD</li><li>Revaloriser de 15 % le salaire de médecin scolaire</li><li>riser les aidants (fiscalité, formations, dons de jours de repos...)</li><li>Renforcer l'interdiction pénale de la GPA</li><li>Lancer un plan de lutte contre les addictions</li><li>Lancer un grand plan Alzheimer</li>"
    }
}, {
    lastName: "Fillon",
    firstName: "François",
    ...
    program: {
        ...
        assurance: "<li>Ramener l’assurance-maladie à l’équilibre d’ici à 2022 en économisant 20 milliards</li><li>Rembourser les lunettes pour les enfants</li><li>Viser d'ici à 2022 un reste à charge zéro pour l'optique, les prothèses dentaires, les audioprothèses</li><li>Revenir sur le plafonnement du remboursement dans les contrats des complémentaires</li><li>Supprimer l'AME, la remplacer par une dispense de frais de santé pour les cas d'urgences ou de maladies contagieuses</li><li>Lutter contre la fraude</li><li>Renforcer le « parcours de soins » grâce à une meilleure coordination entre hôpital et ville et le développement du DMP</li><li>Faciliter l’accès des seniors à une assurance complémentaire de qualité</li><li>Permettre le déploiement rapide des objets connectés notamment pour un meilleur suivi de l’observance des soins</li><li>Déployer l’analyse massive des données via le big data et l’intelligence artificielle</li>",
        desert: "<li>Adapter le numerus clausus aux besoins régionaux et territoriaux</li><li>Développer les maisons médicales</li><li>Garantir une offre de téléconsultation sur tout le territoire</li><li>Favoriser le cumul emploi/retraite</li><li>Incitations à l'installation : dégrèvement URSSAF, CSG, honoraires majorés</li>",
        santePublic: "<li>Rembourser une consultation de prévention (mieux rémunérée pour les médecins) tous les 2 ans pour tous les Français</li><li>Lancer un plan santé à l'école (éducation à la santé, nutrition, prévention aux addictions...)</li><li>Revaloriser la médecine scolaire</li><li>Reconnaître aux aidants un droit à la formation sur le handicap via le compte personnel de formation ou le congé individuel de formation</li><li>Améliorer l’accueil des enfants en situation de handicap, en crèche, à l'école, dans l'enseignement secondaire et supérieur</li><li>Améliorer l’accès aux soins des handicapés</li><li>Mettre en œuvre un 4e « plan autisme »</li><li>Lancer une grande campagne nationale pour financer la recherche sur la maladie d’Alzheimer</li>"
    }
}, {
    lastName: "Hamon",
    firstName: "Benoît",
    ...
    program: {
        ...
        assurance: "<li>Supprimer les franchises médicales</li><li>Diminuer le reste à charge en optique, audioprothèses et soins dentaires</li><li>Simplifier les dispositifs de solidarité (AME, CMU-C et ACS)</li><li>Intervenir pour faire baisser les tarifs des médicaments</li><li>Lutter contre le gaspillage, l'automédication dangereuse</li><li>Encourager la distribution de médicaments à l'unité</li><li>Renforcer la lutte contre la fraude</li><li>Reconnaître le burn out comme maladie professionnelle</li>",
        desert: "<li>Créer 1500 maisons de santé pluridisciplinaires</li><li>Création d'une mission nationale d'accès aux soins pour appuyer l'installation des médecins</li><li>Salarier des médecins en cas d'échec des mesures incitatives à l'installation</li><li>Développer la télémédecine</li>",
        santePublic: "<li>Rembourser l'activité physique prescripte dans certaines maladies chroniques</li><li>Interdire pesticides et perturbateurs endocriniens dangereux</li><li>Légaliser le cannabis</li><li>Étendre la PMA aux femmes seules et aux couples homosexuels</li><li>Créer un droit à une aide médicale à mourir dans la dignité</li><li>Lancement d'un quatrième plan cancer</li><li>Améliorer l'accès aux traitements contre le sida, fixer un objectif de fin d'épidémie à 2030</li><li>Développer la politique de santé mentale, notamment au travers de structures non hospitalières </li><li>Renforcer l'éducation et la promotion de la santé à l'école autour du « parcours éducatif »</li><li>Renforcer la médecine scolaire sur la prévention, la nutrition, les comportements favorables à la santé</li><li>Renforcer la prévention et lutter davantage contre la vente de tabac aux mineurs</li>Inscrire dans la loi le budget de la prévention</li>"
    }
}, {
    lastName: "Lassalle",
    firstName: "Jean",
    ...
    program: {
        ...
        assurance: "<li>Garantir le remboursement de l’ensemble des risques pris en charge par l’Assurance-maladie</li><li>Lutter contre la gabegie financière</li><li>Investir dans les nouveaux outils numériques</li><li>Créer un 5e risque de la Sécurité sociale consacré à la dépendance</li><li>Supprimer l'AME</li><li>Baisser le prix des médicaments coûteux (via l'augmentation des génériques)</li><li>Développer la vente à l'unité</li>",
        desert: "<li>Relever le numerus clausus pour éviter le recours massif aux médecins étrangers</li><li>Instaurer un stage d'internat dans les zones sous-dotées</li><li>Permettre aux médecins retraités d'exercer avec déductions de charge</li><li>Développer les maisons de santé</li>",
        santePublic: "<li>Maintenir l'interdiction de la GPA</li><li>Réserver la PMA aux problèmes de stérilité</li><li>Revaloriser l'allocation aux adultes handicapés</li><li>Développer la prise en charge de l'autisme</li>"
    }
}, {
    lastName: "Macron",
    firstName: "Emmanuel",
    ...
    program: {
        ...
        assurance: "<li>Prise en charge à 100 % des lunettes et des prothèses auditives et dentaires d’ici 2022</li><li>Prise en charge à 100 % des patients atteints d'HTA sévère</li><li>Garantir le remboursement des soins utiles pendant le quinquennat </li><li>Supprimer la cotisation maladie (et chômage) et financer l'Assurance maladie par la CSG</li><li>Généraliser la vente de médicaments à l'unité</li><li>Rediscuter les prix des médicaments</li>",
        desert: "<li>Doubler le nombre de maisons de santé pluridisciplinaires d'ici à 2022</li><li>Relever le numerus clausus en tenant compte des besoins des territoires</li><li>Investir dans la télémédecine</li>",
        santePublic: "<li>Créer un service sanitaire : 40 000 étudiants en santé consacreront 3 mois à des actions de prévention dans les écoles et les entreprises</li><li>Financer des actions de prévention au titre des missions d'intérêt général</li><li>Renforcer le droit à l’oubli pour les personnes ayant été malades</li><li>Augmenter de 100 euros par mois l’Allocation Adulte Handicapé (AAH)</li><li>Donner aux ARS la possibilité de lancer des appels à projets en fonction des besoins locaux</li><li>Poursuivre l'augmentation du prix du tabac et renforcer la prévention</li><li>Limiter les risques d'exposition aux substances à risque</li><li>Mettre en place des maisons du sport santé pour accompagner les personnes atteintes d’affections lourdes</li><li>Aider les aidants (dons de RTT, départ à la retraite anticipé)</li><li>Ouverture de la PMA aux femmes seules et aux couples de femmes</li><li>Maintenir l'interdiction de la GPA</li>"
    }
}, {
    lastName: "Mélenchon",
    firstName: "Jean-Luc",
    ...
    program: {
        ...
        assurance: "<li>Prise en charge à 100 % des soins par l'Assurance-maladie y compris dentaires, optiques et auditifs</li><li>Supprimer l'ONDAM et financer l'Assurance-maladie par la CSG</li><li>Lutter contre les dépenses inutiles; établir une liste de médicaments et de services médicaux dont l'utilité médicale est reconnue</li><li>Créer un pôle public du médicament chargé des activités de recherche et de production de médicaments jugés essentiels</li><li>Renégocier le prix de certains médicaments</li>",
        desert: "<li>Créer un corps de médecins généralistes fonctionnaires rémunérés pendant leurs études</li>",
        santePublic: "<li>Interdire les pesticides nuisibles (glyphosate, néonicotinoïdes, etc)</li><li>Lutter contre la consommation de tabac et d'alcool</li><li>Faire respecter la signalétique nutritionnelle pour lutter contre l'obésité et la malbouffe</li><li>Intégrer pour tout projet ou proposition de loi une étude d'impact sur la santé</li><li>Augmenter le nombre de médecins du travail et de médecins scolaires et revaloriser leur rémunération</li><li>Reconnaissance du droit à décider de sa propre fin, y compris avec assistance (droit inscrit dans la Constitution)</li><li>Remplacer les ARS par des conseils sanitaires de quartier, d'unités territoriales et d'unions départementales de santé</li>"
    }
}, {
    lastName: "Poutou",
    firstName: "Philippe",
    ...
    program: {
        ...
        assurance: "<li>Rembourser à 100 % tous les soins et actes médicaux utiles</li><li>Supprimer les franchises médicales et le forfait hospitalier</li><li>Indemniser à 100 % les pertes de salaire en cas d'arrêt maladie</li><li>Interdire le commerce de l'« assurance santé »</li><li>Intégrer les mutuelles au sein de la Sécu</li><li>Unifier les régimes de la Sécu</li><li>Créer une nouvelle branche de la Sécu pour couvrir la perte d'autonomie liée au handicap ou à l'âge</li>",
        desert: "Aucune proposition connue à ce jour",
				...
				this.check = function(init) {
					...
					if (missing === 0 && func) {
						...
						if (global) {
							...
							if (!hasModule && "function" === "function" && __webpack_require__(58)){ //AMD
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(5), __webpack_require__(59)(module)))
